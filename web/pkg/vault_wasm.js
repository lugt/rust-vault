...
export class VaultHandle {
    static __wrap(ptr) {
        const obj = Object.create(VaultHandle.prototype);
        obj.__wbg_ptr = ptr;
        VaultHandleFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        VaultHandleFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_vaulthandle_free(ptr, 0);
    }
    /**
     ...
     */
    all() {
        const ret = wasm.vaulthandle_all(this.__wbg_ptr);
        if (ret[2]) {
     ...
     */
    count() {
        const ret = wasm.vaulthandle_count(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     ...
     */
    group_by_domain() {
        const ret = wasm.vaulthandle_group_by_domain(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    group_by_letter() {
        const ret = wasm.vaulthandle_group_by_letter(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    group_by_tag() {
        const ret = wasm.vaulthandle_group_by_tag(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
    ...
    put_entries() {
        ...
        let deferred2_1;
        try {
            const ret = wasm.vaulthandle_put_entries(this.__wbg_ptr);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
    ...
    rekey(new_password) {
        ...
        try {
            ...
            const ret = wasm.vaulthandle_rekey(this.__wbg_ptr, ptr0, len0);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
    ...
    search(query) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.vaulthandle_search(this.__wbg_ptr, ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    set_entries(json) {
        const ret = wasm.vaulthandle_set_entries(this.__wbg_ptr, json);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return ret[0] >>> 0;
...
if (Symbol.dispose) VaultHandle.prototype[Symbol.dispose] = VaultHandle.prototype.free;
 ...
 * @returns {VaultHandle}
 */
export function unlock(password, snapshot_json) {
    ...
    return VaultHandle.__wrap(ret[0]);
}
...
const VaultHandleFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_vaulthandle_free(ptr, 1));
